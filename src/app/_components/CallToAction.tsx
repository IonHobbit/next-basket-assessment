...
export default function CallToAction() {
  ...
  return (
    <Stack marginX={{ xs: -5, sm: -6 }} paddingTop={20} paddingBottom={112 / 8} paddingX={{ xs: 5, lg: 416.5 / 8 }} alignItems={'center'} spacing={3.75} sx={{ backgroundImage: `url('/images/section-bg.webp')`, backgroundSize: 'cover' }}>
